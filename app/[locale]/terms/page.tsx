		...
		en: (
			<>
				...
				<p>
					...
					accordance with the laws of {contact.country}.
				</p>
				<p className="mt-3 font-semibold uppercase">
		...
		es: (
			<>
				...
				<p>
					...
					Nos reservamos el derecho de terminar su uso del Servicio o de
					cualquier sitio web relacionado por violar cualquiera de los usos
					prohibidos.
				</p>
				<p className="mt-3 font-semibold uppercase">
				...
				<p className="mt-3 font-semibold uppercase">
					SECCIÓN 17 - CAMBIOS A LOS TÉRMINOS DE SERVICIO
				</p>
				<p>
