   ...
   const privacy: { [key: string]: JSX.Element } = {
      en: (
         <>
            ...
            <p>
               The debit/credit card details and personally identifiable
      ...
      es: (
         <>
            ...
            <p>
               Los datos de la tarjeta de débito o crédito y la información de
               identificación personal NO se almacenarán, venderán, compartirán,
